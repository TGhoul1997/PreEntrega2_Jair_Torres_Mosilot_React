...
export function get_url_image(pokemon) {
...
export async function get_pokemons_by_name(name) {
    const res = await fetch(`https://pokeapi.co/api/v2/pokemon${name}`);
    const data = await res.json();
    return
}

export async function get_pokemons_by_type(type) {
    const res = await fetch(`https://pokeapi.co/api/v2/pokemon${type}`);
    const data = await res.json();
    return data.results
}

export function get_price_by_name(name) {
    let price = 0;
